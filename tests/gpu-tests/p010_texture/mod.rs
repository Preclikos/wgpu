...
#[gpu_test]
static P010_TEXTURE_CREATION_SAMPLING: GpuTestConfiguration =
    GpuTestConfiguration::new()
        ...
        .run_sync(|ctx| {
            ...
            let shader = ctx
                .device
                .create_shader_module(wgpu::include_wgsl!("p010_texture.wgsl"));
            let pipeline = ctx
                .device
...
#[gpu_test]
static P010_TEXTURE_VIEW_PLANE_ON_NON_PLANAR_FORMAT: GpuTestConfiguration =
    GpuTestConfiguration::new()
        .parameters(TestParameters::default().features(
            wgpu::Features::TEXTURE_FORMAT_P010 | wgpu::Features::TEXTURE_FORMAT_16BIT_NORM,
        ))
        .run_sync(|ctx| {
            ...
            fail(
                ...
                Some("aspect plane0 is not in the source texture format r16unorm"),
            );
        });

#[gpu_test]
static P010_TEXTURE_VIEW_PLANE_OUT_OF_BOUNDS: GpuTestConfiguration =
    GpuTestConfiguration::new()
        .parameters(TestParameters::default().features(
            wgpu::Features::TEXTURE_FORMAT_P010 | wgpu::Features::TEXTURE_FORMAT_16BIT_NORM,
        ))
        .run_sync(|ctx| {
            ...
            fail(
                ...
                Some("aspect plane2 is not in the source texture format p010"),
            );
        });

#[gpu_test]
static P010_TEXTURE_BAD_FORMAT_VIEW_PLANE: GpuTestConfiguration =
    GpuTestConfiguration::new()
        .parameters(TestParameters::default().features(
            wgpu::Features::TEXTURE_FORMAT_P010 | wgpu::Features::TEXTURE_FORMAT_16BIT_NORM,
        ))
        .run_sync(|ctx| {
            ...
            fail(
                ...
                Some("unable to view texture p010 as rg16unorm"),
            );
        });

#[gpu_test]
static P010_TEXTURE_BAD_SIZE: GpuTestConfiguration =
    GpuTestConfiguration::new()
        .parameters(TestParameters::default().features(
            wgpu::Features::TEXTURE_FORMAT_P010 | wgpu::Features::TEXTURE_FORMAT_16BIT_NORM,
        ))
        .run_sync(|ctx| {
            ...
            fail(
                ...
                Some("width 255 is not a multiple of p010's width multiple requirement"),
            );
        });
